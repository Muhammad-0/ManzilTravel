...
import icon1 from '../../images/icon/star-2.svg'
            ...
            <div className={`offcanvas-sidebar ${sitebarActive ? "active" : ""}`}>
                ...
                <div className="sidebar-contact-info mb-150">
                    ...
                    <ul className="sidebar-info-list list-unstyled">
                        <li><span><img src={icon1} alt=""/></span>Wasington SY, UK, NY 12099</li>
                        <li><Link onClick={ClickHandler} to="/"><span><img src={icon1} alt=""/></span>+81 800 123 06 78</Link></li>
                        <li><Link onClick={ClickHandler} to="/"><span><img src={icon1} alt=""/></span>evisamail@gmail.com</Link></li>
                    </ul>
                </div>

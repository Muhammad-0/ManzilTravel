        ...
        <section className="cta bg-white">
            <div className="container">
                <div className="xb-brand2__mt">
                    <div className="xb-cta2 ul_li_between" style={{ backgroundImage: `url(${Bg})` }}>
                        ...
                        <Link onClick={ClickHandler} to="/contact" className="thm-btn thm-btn--white thm-btn--trv mt-20">Book a Appointment's<span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none">

                ...
                <div className="xb-footer-widget-wrap ul_li">
                    <div className="footer__widget">
                        ...
                        <ul className="footer__links">
                            ...
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">Company Profile</Link></li>
                            <li><Link onClick={ClickHandler} to="/team">Team Members</Link></li>
                            <li><Link onClick={ClickHandler} to="/contact">Support</Link></li>
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">Career</Link></li>
                        </ul>
                    </div>
                    <div className="footer__widget">
                        <h3 className="widget-title">Top Destination</h3>
                        <ul className="footer__links">
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">New York  Kow City</Link></li>
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">London</Link></li>
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">Romenia</Link></li>
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">Mascot Burz</Link></li>
                            <li><Link onClick={ClickHandler} to="/home-travel-agency">Dhaka Bangladesh</Link></li>
                        </ul>
                    </div>
                    <div className="footer__widget">
                    ...
                    <div className="footer__widget">
                        ...
                        <ul className="footer__links">
                            {CountryList.slice(0, 5).map((country, cnt) => (
                                <li key={cnt}><Link onClick={ClickHandler} to={`/country-single/${country.slug}`}>{country.title}</Link></li>
                            ))}
                        </ul>
                    </div>
                </div>

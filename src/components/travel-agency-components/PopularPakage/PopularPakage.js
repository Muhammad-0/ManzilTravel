                            ...
                            <div className="xb-package mt-30">
                                <div className="xb-item--inner">
                                    ...
                                    <div className="xb-item--holder">
                                        ...
                                        <h2 className="xb-item--title"><Link to="/home-travel-agency">{pakage.title}</Link></h2>
                                        <ul className="xb-item--info ul_li_between">
                                            <li><img src={fhIcon1} alt="" /> {pakage.night} Days {pakage.day} Night</li>
                                            <li><img src={fhIcon2} alt="" />{pakage.people} People</li>
                                        </ul>
                                        <Link to="/home-travel-agency" className="xb-item--btn">Package Start with - <span>${pakage.price}</span></Link>
                                    </div>
                                </div>
                            </div>
                        </div>

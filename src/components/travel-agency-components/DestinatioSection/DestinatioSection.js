...
import dImg1 from '../../../images/destination/img_01.jpg'
import dImg2 from '../../../images/destination/img_02.jpg'
import dImg3 from '../../../images/destination/img_03.jpg'
import dImg4 from '../../../images/destination/img_04.jpg'
import dImg5 from '../../../images/destination/img_05.jpg'
import dImg6 from '../../../images/destination/img_06.jpg'
                ...
                <div className="row gap-40 mt-none-40">
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        <div className="xb-destination style-video mt-40">
                            <div className="xb-item--img">
                                <span className="popup-video" onClick={() => setOpen(true)}><img src={dImg2} alt="" /></span>
                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6">
                        ...
                        <div className="xb-destination style-video mt-40">
                            <div className="xb-item--img">
                                <span className="popup-video" onClick={() => setOpen(true)}><img src={dImg6} alt="" /></span>
                                <span className="xb-item--play popup-video" onClick={() => setOpen(true)}><i className="fas fa-play"></i></span>
                            </div>
                        </div>
                    </div>

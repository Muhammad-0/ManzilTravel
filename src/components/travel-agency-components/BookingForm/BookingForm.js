...
import icon1 from '../../../images/icon/location-2.svg'
import icon2 from '../../../images/icon/arrow-right.svg'
                ...
                <div className="container">
                    <form className="xb-book-form ul_li_between" onSubmit={SubmitHandler}>
                        ...
                        <div className="xb-item--btn">
                            <button className="thm-btn thm-btn--trv">Book Now<span><img src={icon2} alt=""/></span></button>
                        </div>
                    </form>
                </div>
            </div>

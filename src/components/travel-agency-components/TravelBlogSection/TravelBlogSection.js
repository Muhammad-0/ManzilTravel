...
import shape1 from '../../../images/shape/blog_shape.png'
            ...
            <div className="container">
                ...
                <div className="xb-swiper-sliders">
                    ...
                    <div className="ul_li_center mt-40">
                        ...
                        <Link onClick={ClickHandler} className="thm-btn thm-btn--white thm-btn--trv mt-20" to="/blog">More blog<span><svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none">

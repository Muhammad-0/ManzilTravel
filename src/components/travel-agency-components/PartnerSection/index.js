...
import pimg1 from '../../../images/brand/trv_brand_01.png'
import pimg2 from '../../../images/brand/trv_brand_02.png'
import pimg3 from '../../../images/brand/trv_brand_03.png'
import pimg4 from '../../../images/brand/trv_brand_02.png'
                ...
                <Slider {...settings}>
                    {partners.map((partner, pitem) => (
                        <div className="swiper-slide xb-brand xb-brand2" key={pitem}>
                            <Link to="/home-travel-agency" className="xb-item--inner"><img src={partner.pImg} alt="" /></Link>
                        </div>
                    ))}
                </Slider>
            </div>

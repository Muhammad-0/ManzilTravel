...
import tdImg from '../../images/team/team-sinlge.png'
                    ...
                    <div className="team-single__inner">
                        ...
                        <div className="team-single__content">
                            ...
                            <ul className="list-unstyled">
                                <li><span><img src={star} alt=""/></span>Strong attention to detail</li>
                                <li><span><img src={star} alt=""/></span>Excellent communication skills</li>
                                <li><span><img src={star} alt=""/></span>Ability to work under pressure</li>
                                <li><span><img src={star} alt=""/></span>Good organizational skills</li>
                                <li><span><img src={star} alt=""/></span>Cultural sensitivity</li>
                                <li><span><img src={star} alt=""/></span>Language proficiency</li>
                            </ul>
